...
export const PERSONA_EXAMPLE_PROMPTS: Record<string, { en: string[]; de: string[] }> = {
  ...
  "hifi-berater": {
    en: [
      "Price of Naim Uniti Atom?",
      "Is the Rega Planar 3 in stock?",
      "Compare Dynaudio Evoke 20 with Triangle Borea",
      "Show me all turntables",
      "What do you recommend for €2000 budget?",
      "Do we have Bluesound products?",
    ],
    de: [
      "Preis von Naim Uniti Atom?",
      "Ist der Rega Planar 3 lagernd?",
      "Vergleiche Dynaudio Evoke 20 mit Triangle Borea",
      "Zeig mir alle Plattenspieler",
      "Was empfiehlst du für €2000 Budget?",
      "Haben wir Bluesound Produkte?",
    ],
  },
}
