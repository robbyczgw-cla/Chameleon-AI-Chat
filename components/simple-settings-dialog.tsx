...
export function SimpleSettingsDialog({ open, onOpenChange }: SimpleSettingsDialogProps) {
  ...
  const applyTheme = (theme: string) => {
    ...
    html.classList.remove("dark", "girly-violet", "kawaii-pink", "clay-dream", "industrial", "ocean-breeze", "paper-mint", "clean-slate", "midnight-hologram", "cosmic-glass", "modern-light")
    if (theme !== "light") {
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                  {[
                    ...
                    { value: "clay-dream", label: "Clay 🍬", bg: "bg-gradient-to-br from-purple-200 via-violet-100 to-pink-100", border: "border-purple-300" },
