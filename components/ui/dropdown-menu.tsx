  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        // Hover and focus states - make ALL text readable
        "hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground",
        // Force all nested text to be readable on hover/focus
        ...
        // SVG icons
        "[&_svg:not([class*='text-'])]:text-muted-foreground [&:hover_svg:not([class*='text-'])]:!text-accent-foreground",
        // Disabled and inset
