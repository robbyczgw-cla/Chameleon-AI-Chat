...
export function AIDebateMode() {
  ...
  const defaultModel = settings.selectedModel || "x-ai/grok-4.1-fast:free"
  ...
  const debateModels = Array.from(new Set([defaultModel, model1, model2, ...availableModels])).slice(0, 15)
