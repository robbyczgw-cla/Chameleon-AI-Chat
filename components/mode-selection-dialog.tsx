...
const translations = {
  en: {
    ...
    simpleFeature2: "Easy persona selection",
    simpleFeature3: "Web search built-in",
    simpleFeature4: "Voice input & output",
    advancedMode: "Advanced Mode",
    advancedDesc: "Full control for power users",
    advancedFeature1: "MCP tools integration",
    advancedFeature2: "Custom system prompts",
    advancedFeature3: "Advanced model settings",
    advancedFeature4: "Memory & RAG systems",
  ...
  de: {
    ...
    simpleFeature2: "Einfache Persona-Auswahl",
    simpleFeature3: "Integrierte Websuche",
    simpleFeature4: "Spracheingabe & -ausgabe",
    advancedMode: "Erweiterter Modus",
    advancedDesc: "Volle Kontrolle für Power-User",
    advancedFeature1: "MCP-Tools Integration",
    advancedFeature2: "Eigene System-Prompts",
    advancedFeature3: "Erweiterte Modell-Einstellungen",
    advancedFeature4: "Speicher & RAG-Systeme",
