  ...
  return (
    <div className="space-y-4">
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={(open) => {
        ...
        <DialogContent nested className="w-[95vw] sm:max-w-2xl lg:max-w-4xl max-h-[min(85vh,calc(100dvh-3rem))] md:max-h-[calc(100vh-3rem)] !overflow-hidden flex flex-col bg-background">
          <DialogHeader>
