...
ALTER COLUMN selected_model SET DEFAULT 'x-ai/grok-4-fast';
...
SET selected_model = 'x-ai/grok-4-fast'
...
DO $$
BEGIN
  RAISE NOTICE 'Updated default model from gpt-4o to x-ai/grok-4-fast';
END $$;
