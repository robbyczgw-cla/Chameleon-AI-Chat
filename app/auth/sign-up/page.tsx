...
import { GoogleLogo, Shield, Sparkle } from "@phosphor-icons/react"
                ...
                <form onSubmit={handleSignUp}>
                  <div className="flex flex-col gap-4">
                    ...
                    <Button
                      type="button"
                      variant="outline"
                      className="w-full h-10 text-sm font-semibold border-2 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-300"
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="flex items-center gap-1.5 p-2 rounded-lg bg-white/40 dark:bg-slate-800/40 border border-white/20 dark:border-white/10">
                  ...
                  <span className="font-semibold text-foreground text-[11px]">Cloud Sync</span>
                </div>
                <div className="flex items-center gap-1.5 p-2 rounded-lg bg-white/40 dark:bg-slate-800/40 border border-white/20 dark:border-white/10">
                  <span className="text-sm">🧠</span>
                  <span className="font-semibold text-foreground text-[11px]">AI Memory</span>
                </div>
                <div className="flex items-center gap-1.5 p-2 rounded-lg bg-white/40 dark:bg-slate-800/40 border border-white/20 dark:border-white/10">
                  <span className="text-sm">🔗</span>
                  <span className="font-semibold text-foreground text-[11px]">Chat Sharing</span>
                </div>
                <div className="flex items-center gap-1.5 p-2 rounded-lg bg-white/40 dark:bg-slate-800/40 border border-white/20 dark:border-white/10">
                  <span className="text-sm">💾</span>
                  <span className="font-semibold text-foreground text-[11px]">Auto Backup</span>
                </div>
              </div>
